...
class Testing:
    """This class calls all other classes, execute them, prints out all
       desired outputs, and saves statistics as report.txt.
    """
    start = time.time()    
    print("**************************************************") 
    ...
    file_path="dnslog.txt"
    name_report="report.txt"
    ...
    diff=(end - start)*1000  #in miliseconds, just for execution time
    print("*------------------------------------------------*")
